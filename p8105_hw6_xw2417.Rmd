...
The code chunk below compares my model to two other:
...
In the `boot_straps_df` dataset, the 2.5% quantile is `r low_quantile` and the 97.5% quantile is `r high_quantile`.